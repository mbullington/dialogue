...
import mbullington.dialogue.command.handler.AwayHandler;
import mbullington.dialogue.command.handler.BackHandler;
import mbullington.dialogue.command.handler.CloseHandler;
import mbullington.dialogue.command.handler.DCCHandler;
import mbullington.dialogue.command.handler.DeopHandler;
import mbullington.dialogue.command.handler.DevoiceHandler;
import mbullington.dialogue.command.handler.EchoHandler;
import mbullington.dialogue.command.handler.HelpHandler;
import mbullington.dialogue.command.handler.JoinHandler;
import mbullington.dialogue.command.handler.KickHandler;
import mbullington.dialogue.command.handler.MeHandler;
import mbullington.dialogue.command.handler.ModeHandler;
import mbullington.dialogue.command.handler.MsgHandler;
import mbullington.dialogue.command.handler.NamesHandler;
import mbullington.dialogue.command.handler.NickHandler;
import mbullington.dialogue.command.handler.NoticeHandler;
import mbullington.dialogue.command.handler.OpHandler;
import mbullington.dialogue.command.handler.PartHandler;
import mbullington.dialogue.command.handler.QueryHandler;
import mbullington.dialogue.command.handler.QuitHandler;
import mbullington.dialogue.command.handler.RawHandler;
import mbullington.dialogue.command.handler.TopicHandler;
import mbullington.dialogue.command.handler.VoiceHandler;
import mbullington.dialogue.command.handler.WhoisHandler;
